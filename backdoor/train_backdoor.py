...
def train_backdoor(dataloaders, model_name, trigger_type='pattern', epochs=100, lr=0.01, momentum=0.9, wd=1e-4,
...
def learning_rate_scheduler(optimizer, total_epochs):
    ...
    return LambdaLR(optimizer, _lr_lambda, total_epochs)
...
def generate_backdoor(x_clean, y_clean, percent_poison, num_class, backdoor_type='pattern', targets=1):
    """
...
if __name__ == "__main__":
    ...
    train_dataset = datasets.CIFAR10(root, train=True, transform= transform_train, download=False)
